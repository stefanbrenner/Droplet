...
public class DeviceOnAction extends AbstractSerialAction {
	...
	public DeviceOnAction(JFrame frame, IDropletContext dropletContext, IDevice device) {
	...
	public void actionPerformed(ActionEvent event) {
		...
		String message = messageProtocolProvider.createDeviceOnMessage(getDroplet().getDevices().indexOf(device) + 1);
