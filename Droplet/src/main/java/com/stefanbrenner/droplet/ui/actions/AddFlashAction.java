...
public class AddFlashAction extends AbstractAddSingleDeviceAction {
	
	public AddFlashAction(final JFrame frame, final IDropletContext dropletContext, final boolean iconOnly) {
