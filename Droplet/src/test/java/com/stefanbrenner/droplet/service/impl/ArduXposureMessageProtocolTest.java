...
public class ArduXposureMessageProtocolTest {
	...
	public void testCreateStartMessage() {
		...
		assertTrue(Arrays.equals(new byte[] { 1, 1, 127 }, protocol.createStartMessage(1, 250).getBytes()));
		assertTrue(Arrays.equals(new byte[] { 1, 5, 0 }, protocol.createStartMessage(5, 0).getBytes()));
		assertTrue(Arrays.equals(new byte[] { 1, 5, 127 }, protocol.createStartMessage(5, 250).getBytes()));
	}
