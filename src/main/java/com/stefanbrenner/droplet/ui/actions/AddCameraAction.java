...
public class AddCameraAction extends AbstractAddSingleDeviceAction {
	
	public AddCameraAction(final JFrame frame, final IDropletContext dropletContext, final boolean iconOnly) {
